...
Мульти-трекерный торрент-агрегатор одним бинарником на Go. 23 парсера покрывают
22 русскоязычных и украинских трекера и наполняют единую файловую базу, поверх
которой работают API поиска, синхронизации и статистики, а также
Jackett-совместимый эндпоинт для клиентов, которые его ждут.
...
| `/trackers` | `trackers.html` — состояние всех 23 парсеров: последний прогон, маршрут, авторизация, запуск вручную |
